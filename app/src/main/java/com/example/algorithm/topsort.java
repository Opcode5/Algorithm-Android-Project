...
public class topsort extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_topsort);
        //create scroll bar
        TextView tv=(TextView)findViewById(R.id.t2);
        tv.setMovementMethod(new ScrollingMovementMethod());

        final VideoView k=(VideoView) findViewById(R.id.topsort);
        k.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.topsort)) ;
